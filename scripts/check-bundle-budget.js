...
const BUDGETS = [
    {
        ...
        mustNotContain: [
            ...
            //    و🔴 ثاني خطأ في نفس السطر، كشفه **النشر لا الاختبار**: العلامة
            //    كانت `sentry` فطابقت **عنوان الـDSN المحقون** (`…ingest.sentry.io…`)
            //    وهو نصٌّ في حزمة الدخول بطبيعته. ولأن `SENTRY_DSN` فارغٌ على
            //    جهازي ومضبوطٌ على Vercel، مرّ محلياً وأسقط النشر — وهو أخبثُ
            //    صنفٍ من الفروق: لا يظهر إلا حيث لا أرى.
            //    القياس الفاصل (بناءٌ محلّي بـDSN وهمي، والحزمة كسولة سليمة):
            //      sentry=1 · ingest.sentry.io=1 · replayIntegration=1
            //      **@sentry/ = 0**  ⇐ وحدها تميّز الحزمة عن إعدادها وندائنا.
