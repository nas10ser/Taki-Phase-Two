...
- **الإصدار الحالي: v14.29** (آخر إصدار في `progress.md` — الأحدث في الأعلى) · البوت `14.29.0`
...
2. 🔴 **مفاتيح بوابة الدفع لمتجر ناصر** — المؤشّر في `merchant_gateways` يشير
   إلى سرّ غير موجود في الخزنة، فزرّ «ادفع الآن» مقفل لكل المتاجر. يُصلَح بحفظ
   المفاتيح مرّة من لوحة التاجر (لا يُدخلها Claude — قاعدة «مفاتيح البوابة للتاجر وحده»).
