...
const SellerDashboard: React.FC = () => {
    ...
    React.useEffect(() => {
        if (!user) return;
        // Functional updates so an unchanged value short-circuits the
        // re-render. Previously mapPos was in deps AND setMapPos was passed a
        // fresh array literal — that produced an infinite render loop.
        if (user.shop) {
