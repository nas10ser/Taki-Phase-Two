        ...
        <div className="page-content" style={{ background: 'var(--body-bg)', minHeight: '100vh', direction: isRTL ? 'rtl' : 'ltr' }}>
            ...
            <div className="animate-fade-in" style={{
                ...
                <div style={{ marginTop: 24, background: 'rgba(0,0,0,0.2)', padding: 20, borderRadius: 20, border: '1px solid rgba(80, 80, 90, 0.3)' }}>
                    ...
                    {/* v13.72 (أمر ناصر): شريط تبويبات التاجر نزل إلى هنا — **تحت**
                        رقم التواصل وواتساب. كان أعلى الصفحة فوق اسم المتجر فيزاحم
                        هوية المتجر التي جاء الزائر من أجلها؛ ومكانه الطبيعي بعد
                        معلومات المتجر مباشرة. يظهر لصاحب المتجر وحده. */}
                    {user?.id === store.id && (
