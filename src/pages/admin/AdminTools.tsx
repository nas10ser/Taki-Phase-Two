...
const ToggleCard = memo<{
    ...
    const colors = {
        green: enabled ? 'bg-emerald-500' : 'bg-gray-300',
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[3000] flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl">
                ...
                <div className="p-5 space-y-4">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-600 mb-1.5">المكان</label>
                        <select
                            value={form.position}
                ...
                <div className="sticky bottom-0 bg-gray-50 p-4 rounded-b-3xl flex gap-3 border-t">
                    <button
                        onClick={onClose}
...
const Field = memo<{
    ...
    <div>
        ...
        <input
            ...
            className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:border-orange-500 focus:bg-white outline-none"
        />
    </div>
));
...
const AdminTools: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in" dir="rtl">
            <div>
                <h1 className="text-2xl font-extrabold text-gray-900">🛠️ أدوات الإدارة</h1>
            ...
            {/* Settings */}
            <section>
                <h2 className="text-lg font-bold text-gray-800 mb-3">⚙️ الإعدادات العامة</h2>
            ...
            <section>
                <div className="flex items-center justify-between mb-3">
                    <h2 className="text-lg font-bold text-gray-800">🖼️ البانرات الإعلانية</h2>
                    <button
                                ...
                                <div className="p-3">
                                    ...
                                    <div className="flex gap-2 mt-3">
                                        <button
                                            ...
                                            className="flex-1 py-1.5 text-xs font-bold bg-gray-50 hover:bg-gray-100 rounded-lg"
                                        >
            ...
            {/* Campaigns */}
            <section>
                <h2 className="text-lg font-bold text-gray-800 mb-3">📢 الحملات الترويجية</h2>
                {campaigns.length === 0 ? (
                    <div className="bg-white rounded-2xl p-8 border border-dashed border-gray-200 text-center text-sm text-gray-500">
                        ...
                        {campaigns.map((c) => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-xs text-gray-500 truncate">{c.body_ar}</div>
