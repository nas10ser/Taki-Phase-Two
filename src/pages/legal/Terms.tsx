        ...
        >
            ...
            <Section n={3} title={isRTL ? 'الأهلية وشروط التسجيل' : 'Eligibility and registration conditions'}>
                ...
                <Bullets items={isRTL ? [
                    ...
                    <>Account deletion: your account is deactivated <strong>immediately</strong> on request, so it neither appears nor can be used, and you may undo this by signing in within <strong>30 days</strong>. After that window your personal data is permanently erased (name, mobile, email, addresses, photo), while your past orders remain in the merchant's records <strong>without identity</strong>, because those are their books and tax invoices which the law requires them to keep.</>,
            ...
            <Section n={5} title={isRTL ? 'آلية الحجز والدفع والاستلام' : 'Booking, payment and delivery mechanism'}>
                <Bullets items={isRTL ? [
                    ...
                    <>مدّة صلاحية الحجز <HoldHours kind="pickup" /> لطلب الاستلام و<HoldHours kind="delivery" /> لطلب التوصيل، من لحظة التأكيد (ما لم تُعلن المنصّة خلاف ذلك) — عند انتهائها دون استلام يُلغى الحجز تلقائياً وتُعاد الكمّية للعرض، دون أيّ التزام مالي على المشتري. وفي التوصيل تتوقّف المهلة بمجرّد انطلاق المندوب، والطلب المدفوع إلكترونياً لا يُلغى تلقائياً.</>,
