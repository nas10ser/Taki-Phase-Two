...
const howItWorksAR: QA[] = [
    ...
    },
    {
        ...
        a: <p>التصفّح والحجز مجانيان للمشتري: لا اشتراك ولا عمولة ولا رسوم خفية من المنصّة. مصدر الدخل (حالياً أو مستقبلاً) قد يكون اشتراكات التجار مقابل خدمات النشر والظهور، أو شراكات مع علامات تجارية. والمبلغ الوحيد الذي قد يدفعه المشتري فوق ثمن البضاعة هو <strong>رسوم التوصيل</strong> إن اختاره، ويحدّدها التاجر وتظهر قبل التأكيد.</p>,
    },
    {
